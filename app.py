...
if model is not None and df is not None:
    ...
    if st.button("🚀 Predict Cluster", use_container_width=True, key="predict_btn"):
        ...
        with col2_info:
            ...
            cluster_stats = clustered_data[clustered_data['labels'] == cluster]
        ...
        with viz_col1:
            ...
            fig = px.scatter_3d(
                ...
                color=clustered_df['labels'].astype(str),
        ...
        with viz_col2:
            ...
            cluster_counts = clustered_df['labels'].value_counts().sort_index()
